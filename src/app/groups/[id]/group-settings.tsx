...
import { ManageRecurringModal } from "./manage-recurring-modal";
...
export function GroupSettings({ groupId, groupName, isCreator }: Props) {
  ...
  return (
    <>
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="absolute right-0 top-11 z-50 min-w-[210px] overflow-hidden rounded-xl border border-[#E5E7EB] bg-white shadow-xl"
            >
              {showRename ? (
                ...
                <div className="py-1">
                  ...
                  <button
                    onClick={() => { setOpen(false); setShowRecurring(true); }}
                    className="flex w-full items-center gap-2.5 px-4 py-2.5 text-sm text-[#1A1A2E] transition hover:bg-[#F7F8FA]"
                  >
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-[#6B7280]">
                    This will permanently delete all expenses and settlements. This cannot be undone.
                  </p>
      ...
      {/* Manage recurring modal — rendered outside dropdown container */}
      <AnimatePresence>
        {showRecurring && (
